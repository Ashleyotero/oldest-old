...
<?php echo $curauth->nickname; ?>
			</h4> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/authors/<?php echo $curauth->last_name; ?>.jpg" alt="<?php echo $curauth->nickname; ?>" /> <h6>Profile:</h6> 
			<p class="small">
...
<?php while (have_posts()) : the_post(); ?>
		<div class="entry">
			<h2 class="entry-title"><a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title(); ?>" class="title"> 
<?php the_title(); ?>
				</a></h2> 
