...
<h3><em><a href="<?php echo get_category_link($dt_mid_right_cat);?>"><?php echo $cat_name; ?></a></em></h3>
<hr />
<?php while (have_posts()) : the_post(); ?>
<div class="post-<?php the_ID(); ?>">
<h6><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h6> 
...
if (function_exists( 'get_option_tree') && get_option_tree( 'berlin_bottom_1') <> '') { 
    ...
    if (function_exists( 'get_option_tree') && get_option_tree( 'berlin_bottom_2') <> '') { 
        $dt_bot_2nd_cat = get_option_tree( 'berlin_bottom_2'); 
       }    
                                                                

    if (function_exists( 'get_option_tree') && get_option_tree( 'berlin_bottom_3') <> '') { 
        $dt_bot_3rd_cat = get_option_tree( 'berlin_bottom_3'); 
        }
            
    if (function_exists( 'get_option_tree') && get_option_tree( 'berlin_bottom_4') <> '') { 
        $dt_bot_4th_cat = get_option_tree( 'berlin_bottom_4'); 
       }
            
    if (function_exists( 'get_option_tree') && get_option_tree( 'berlin_bottom_5') <> '') { 
        $dt_bot_5th_cat = get_option_tree( 'berlin_bottom_5'); 
       }
