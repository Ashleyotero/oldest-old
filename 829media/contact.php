...
<div id="container">
  ...
  <div id="sidebar2"><img src="images/contact.png" width="154" height="30" class="z" />
    ...
    Phone: (575) 496-5002</p>
        ...
        <form action="process_contact.php" method="post" enctype="multipart/form-data" class="contact_form">
          <fieldset>
          <label for="name">Name </label>
          <input type="text" size="20" name="name" class="text" value="" id="name"  maxlength="100" maxsize="100" />
          </fieldset>
          <fieldset>
          <label for="email">E-mail </label>
          <input type="text" id="email" onkeyup="checkEmail(this);" />
          <span class="hint">Please enter a valid email address - we don't spam!</span>
                    </fieldset>
          <fieldset>
          <label for="phone">Phone </label>
          <input type="text" id="phone" onkeyup="checkPhoneForLength(this);" />
          <span class="hint">Phone numbers must be a least 7 characters in length (5555555).</span>
                    </fieldset>
                    
          <fieldset>
          <label for="name">Name </label><textarea name="comments" id="comments" rows="8" cols="35" class="texta"></textarea> 
          </fieldset>
