...
$query = "SELECT * FROM sam_gallery WHERE gallery_num='5'"; 
...
?>
      <form method="post" action="updated_jewelry.php" enctype="multipart/form-data">
...
&nbsp;</td>
                ...
                <tr align="left" valign="top">
                  ...
                  <input type="submit" name="Submit" value="Update Jewelry Gallery" />
                  </div></td>
                </tr>
              </table>
      </form>
