...
<table width="900" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td valign="top" id="content"><h3>Update Portraits Gallery</h3>
...
$query = "SELECT * FROM sam_gallery WHERE gallery_num='4'"; 
...
?>
      <form method="post" action="updated_portraits.php" enctype="multipart/form-data">
...
&nbsp;</td>
                ...
                <tr align="left" valign="top">
                  ...
                  <input type="submit" name="Submit" value="Update Portraits Gallery" />
                  </div></td>
                </tr>
              </table>
      </form>
